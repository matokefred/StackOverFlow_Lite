...
class Tdd(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.question = {'id': 1, 'content': 'Default question'}

    def test_get_all_questions(self):
        '''A test on the get_questions method'''
        response = self.client().get('/apiv1/questions',
    ...
    def test_get_a_question(self):
        ...
        response = self.client().get('/apiv1/questions/4',
                                     content_type='application/json',
                                     data=json.dumps(self.question))
    ...
    def test_add_question(self):
        ...
        response = self.client().post('/apiv1/questions',
                                      content_type='application/json',
                                      data=json.dumps(self.question))
        self.assertIn(b'You added this question', response.data)
        self.assertEqual(response.status_code, 201)

    def test_add_answer(self):
        '''Test add_answer method'''
        response = self.client().post('/apiv1/questions/2/answers',
                                      content_type='application/json',
                                      data=json.dumps(self.question))
        self.assertEqual(response.status_code, 400)
    ...
    def test_delete_question(self):
        ...
        response = self.client().delete('/apiv1/questions/1',
                                        content_type='application/json',
                                        data=json.dumps(self.question))
        self.assertEqual(response.status_code, 204)

    def tearDown(self):
        '''Clearing the initialized variables'''
        del self.question
